...
type {{.schema.CodeName}}Operations interface {
    List(opts *clientbase.ListOpts) (*{{.schema.CodeName}}Collection, error)
    ListAll(opts *clientbase.ListOpts) (*{{.schema.CodeName}}Collection, error)
...
func (c *{{.schema.CodeName}}Client) List(opts *clientbase.ListOpts) (*{{.schema.CodeName}}Collection, error) {
...
func (c *{{.schema.CodeName}}Client) ListAll(opts *clientbase.ListOpts) (*{{.schema.CodeName}}Collection, error) {
    resp := &{{.schema.CodeName}}Collection{}
